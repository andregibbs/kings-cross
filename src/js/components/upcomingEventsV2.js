// modified version of upcomingEvents for use with FetchQudiniEvents
  ...
  if (!sorted_dates.length) {
    ...
    for (var i = 0; i < 5; i++) {
      ...
      const options = {
        ...
        suitables: sorted_dates[i].properties.eventtype,
        suitablesName: sorted_dates[i].properties.eventtypeName,
        passionColor: sorted_dates[i].properties.passionColor || sorted_dates[i].color,
