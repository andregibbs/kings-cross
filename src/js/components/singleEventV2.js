// modified version of singleEvent for use with FetchQudiniEvents

import handleTemplate from "./handleTemplate";
import instagram from "./instagram";
import upcomingEvents from "./upcomingEventsV2";
      ...
      function updateTimes(dates, currentDate) {
        ...
        times.forEach(event => {
          ...
          var html =
            ...
            slots +
            '"data-id="' + event.id + '" data-link="' + event.properties.externalbookinglink + '" >' +
            '<h4 class="time__int">' +
            formattedStartTime +
