    ...
    if (event.description) {
      ...
      if (bits.length > 1) {
        ...
        if (IsJsonString(bits[1])) {
          ...
          event.extra["passionColor"] = getPassionColor(
            event.extra.passions[0]
          );
      ...
      .success(function (data) {
        ...
        for (var j = 0; j < events.length; j++) {
          ...
          if (
            ...
            eventStartDate.getTime() <= weekEnd.getTime()
          ) {
          ...
          // this month
          if (
            eventStartDate.getTime() >= monthStart.getTime() &&
            eventStartDate.getTime() <= monthEnd.getTime()
          ) {
          ...
          case "one":
            setTimeout(function () {
              $("html, body").animate(
                {
                  scrollTop:
                    $("#weekOne").offset().top - parseInt(navBarHeight),
                },
                500
              );
            }, 2000);
          ...
          case "two":
            setTimeout(function () {
              $("html, body").animate(
                {
                  scrollTop:
                    $("#weekTwo").offset().top - parseInt(navBarHeight),
                },
                500
              );
            }, 2000);
          ...
          case "three":
            setTimeout(function () {
              $("html, body").animate(
                {
                  scrollTop:
                    $("#weekThree").offset().top - parseInt(navBarHeight),
                },
                500
              );
            }, 2000);
          ...
          case "four":
            setTimeout(function () {
              $("html, body").animate(
                {
                  scrollTop:
                    $("#weekFour").offset().top - parseInt(navBarHeight),
                },
                500
              );
            }, 2000);
