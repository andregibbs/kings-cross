...
},{"./handlebars/base":8,"./handlebars/exception":11,"./handlebars/no-conflict":24,"./handlebars/runtime":25,"./handlebars/safe-string":26,"./handlebars/utils":27}],8:[function(require,module,exports){
'use strict';
...
},{"./decorators":9,"./exception":11,"./helpers":12,"./internal/proto-access":21,"./logger":23,"./utils":27}],9:[function(require,module,exports){
'use strict';
...
},{"../exception":11,"../utils":27}],15:[function(require,module,exports){
'use strict';
...
},{"../exception":11,"../utils":27}],17:[function(require,module,exports){
'use strict';
...
},{"../exception":11,"../utils":27}],20:[function(require,module,exports){
'use strict';
...
},{"../logger":23,"./create-new-lookup-object":20}],22:[function(require,module,exports){
'use strict';
...
},{"./base":8,"./exception":11,"./helpers":12,"./internal/proto-access":21,"./internal/wrapHelper":22,"./utils":27}],26:[function(require,module,exports){
...
},{"handlebars/runtime":7}],29:[function(require,module,exports){
/*!
...
},{"./shorter-css-color-names":33}],33:[function(require,module,exports){
module.exports = {
...
},{"./components/common/KXNav":41,"./components/common/kxSurvey":44,"./components/findKX":45,"./util/GATracking.js":53,"es6-promise/auto":4,"jquery":29,"lity":30,"whatwg-fetch":35}],41:[function(require,module,exports){
'use strict';
...
},{"../../animation/nav-burger-animation.json":39,"./kxSearch":43}],42:[function(require,module,exports){
'use strict';
...
var countdownTemplate = require('../../../templates/partials/components/common/kxCountdown/kxCountdown.hbs');
var digitTemplate = require('../../../templates/partials/components/common/kxCountdown/KXCountdownDigit.hbs');

var KXCountdown = function () {
  function KXCountdown(el, endDateTime) {
    var customCurrentTime = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var autoUpdate = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;

    _classCallCheck(this, KXCountdown);

    this.el = el;
    this.endDateTime = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(endDateTime)).setZone("GMT");
  ...
  KXCountdown.prototype.setupTemplate = function setupTemplate() {
    this.el.innerHTML = "";
    // render template
    this.el.insertAdjacentHTML('beforeend', countdownTemplate());
  };

  KXCountdown.prototype.update = function update() {
    var customCurrentTime = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

    // current local time
    var currentDateTime = customCurrentTime ? customCurrentTime : _luxon.DateTime.local();
    // calculate diffs
    var diffs = this.endDateTime.diff(currentDateTime, ['days', 'hours', 'minutes', 'seconds']);
    // stringify diff values
    var sDays = diffs.days.toString();
    var sHours = diffs.hours.toString();
    var sMinutes = diffs.minutes.toString();
    var sSeconds = Math.floor(diffs.seconds).toString();
...
var KXCountdownDigit = function () {
  function KXCountdownDigit(el, digit) {
    _classCallCheck(this, KXCountdownDigit);
  ...
  KXCountdownDigit.prototype.update = function update(newDigit) {
  ...
  return KXCountdownDigit;
}();

exports.default = KXCountdown;

},{"../../../templates/partials/components/common/kxCountdown/KXCountdownDigit.hbs":56,"../../../templates/partials/components/common/kxCountdown/kxCountdown.hbs":57,"luxon":31}],43:[function(require,module,exports){
'use strict';
...
},{"../../../data/config.json":36,"../../../templates/helpers/handlebarsHelpers":55,"../../../templates/partials/components/common/kxEventTile.hbs":58,"../../../templates/partials/home-of-innovation/hoiLinkList.hbs":63,"../../../templates/partials/home-of-innovation/partials/listItem.hbs":64,"../../../templates/partials/home-of-innovation/partials/listItemSpacer.hbs":65,"../../util/Events":52,"../../util/KXEnv":54,"fuse.js":6,"hbsfy/runtime":28}],44:[function(require,module,exports){
'use strict';
...
},{"../../../../src/data/kxSurveyData":37,"../../../templates/partials/components/common/kxSurvey.hbs":59,"../../util/KXEnv":54,"../getParam":46}],45:[function(require,module,exports){
'use strict';
...
},{"../util/KXEnv":54}],46:[function(require,module,exports){
'use strict';
...
var _GATracking = require('../util/GATracking');

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var HoiBambuser = function () {
  function HoiBambuser(el) {
    _classCallCheck(this, HoiBambuser);
    ...
    */
    var fixEl = document.body;
    var settouch = function settouch(e) {
      return fixEl.style.webkitOverflowScrolling = 'touch';
    };
    fixEl.addEventListener("touchend", settouch, false);
  }

  HoiBambuser.prototype.fetchSKUData = function fetchSKUData(skus) {
    return fetchProductData(skus.join(','));
  };

  HoiBambuser.prototype.hydrateProducts = function hydrateProducts(player, products, skuData) {
    products.forEach(function (_ref) {
      ...
      var productData = skuData.find(function (data) {
        return data.code.toLowerCase() === sku.toLowerCase();
      });
      if (productData !== undefined) {
        player.updateProduct(productId, function (factory) {
          ...
          var nameWithoutDetail = productData.name.replace(new RegExp(/(\(.*\))/, 'gm'), '').trim();
          return factory.inheritFromPlaceholder().publicUrl(publicUrl).product(function (p) {
            return p.name(nameWithoutDetail).sku(sku).variations(function (v) {
              return [v().name(nameWithoutDetail).sku(sku).sizes(function (s) {
                return [s().name(nameWithoutDetail).sku(sku).price(function (pr) {
                  return pr.current('' + productData.price.value);
                })];
              })];
            });
          });
  ...
  HoiBambuser.prototype.onShoppingReady = function onShoppingReady(player) {
    var _this = this;
    ...
    player.on(player.EVENT.PROVIDE_PRODUCT_DATA, function (event) {
      var skus = event.products.map(function (p) {
        return p.ref;
      });
      _this.fetchSKUData(skus).then(function (skuData) {
        _this.hydrateProducts(player, event.products, skuData);
      }).catch(function (e) {
  ...
  HoiBambuser.prototype.processMediaEvent = function processMediaEvent(event) {
    if (event.origin != "https://lcx-player.bambuser.com") {
      return;
    }
    var trackingEvent = JSON.parse(event.data);
    var trackingData = trackingEvent.data;
    ...
    var TRACKING = {
      ...
      prefix: function prefix(label) {
        return 'uk:kings-cross:samsung-people-live:' + label;
      }
    };
    switch (trackingEvent.eventName) {
      ...
      case 'livecommerce:minimize':
        (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.MINIMIZE));
        break;
      case 'livecommerce:tracking-point':
        // tracking event
        var eventData = trackingData.data;
        switch (eventData.interactionType) {
          case 'hideAllProductsOverlay':
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.CLOSE_PRODUCTS));
            break;
          case 'goToProductSurfBehind':
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.PRODUCT_CLICK + ':' + eventData.title));
            break;
          case 'showAllProductsOverlay':
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.OPEN_PRODUCTS));
            break;
          case 'resume':
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.PLAY));
            break;
          case 'pause':
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.PAUSE));
            break;
          case 'action-bar:share':
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.SHARE));
            break;
          case 'like':
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.LIKE));
            break;
          ...
          case 'pending-curtain:share:clipboard':
            var shareType = eventData.interactionType.split('pending-curtain:share:')[1];
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.SHARE + ':' + shareType));
            break;
          ...
          case 'pending-curtain:addToCalendar:ics':
            var calendarType = eventData.interactionType.split('pending-curtain:addToCalendar:')[1];
            (0, _GATracking.trackEvent)(TRACKING.CATEGORY, TRACKING.ACTION, TRACKING.prefix(TRACKING.CALENDAR + ':' + shareType));
            break;
          default:
...
exports.default = HoiBambuser;


function fetchProductData(skus) {
  // host name for qa / live
  var hostname = window.location.hostname == 'p6-qa.samsung.com' ? 'p6-qa.samsung.com' : 'www.samsung.com';
  // return fetch(`https://${hostname}/uk/api/v4/configurator/syndicated-product-linear?skus=${skus}`)
  // use new hybris api
  return fetch('https://p1-smn2-api-cdn.shop.samsung.com/tokocommercewebservices/v2/uk/products?fields=FULL&productCodes=' + skus).then(function (response) {
...
},{"../util/GATracking":53}],49:[function(require,module,exports){
'use strict';
...
var _addToCalendar = require('../animation/add-to-calendar.json');

var _addToCalendar2 = _interopRequireDefault(_addToCalendar);

var _addToCalendarButtons = require('add-to-calendar-buttons');

var _miniSvgDataUri = require('mini-svg-data-uri');

var _miniSvgDataUri2 = _interopRequireDefault(_miniSvgDataUri);

var _google = require('../../templates/partials/svg/google.svg');

var _google2 = _interopRequireDefault(_google);

var _apple = require('../../templates/partials/svg/apple.svg');

var _apple2 = _interopRequireDefault(_apple);

var _outlook = require('../../templates/partials/svg/outlook.svg');
...
var HOIAddToCalendar = function () {
  function HOIAddToCalendar(element) {
    _classCallCheck(this, HOIAddToCalendar);
  ...
  HOIAddToCalendar.prototype.hideComponent = function hideComponent() {
    this.el.style.visibility = 'hidden';
  };

  HOIAddToCalendar.prototype.getCalendarData = function getCalendarData() {
    var data = {};
    var mainEl = this.el;
    function attr(key) {
      return mainEl.getAttribute('data-' + key);
    }
    ['title', 'description', 'address', 'start', 'end', 'duration'].forEach(function (key) {
      var value = attr(key);
      if (value) {
        switch (key) {
          case 'start':
  ...
  HOIAddToCalendar.prototype.componentModifications = function componentModifications() {
    var _this = this;

    var ctaText = 'Remind Me';
    var icons = [{ cls: 'ical', svg: _apple2.default, text: 'Apple' }, { cls: 'google', svg: _google2.default, text: 'Google/Android' }, { cls: 'outlook', svg: _outlook2.default, text: 'Outlook' }];
    function styleString(_ref) {
      var cls = _ref.cls,
          svg = _ref.svg;

      return document.createTextNode('.icon-' + cls + ':before { background-image: url("' + (0, _miniSvgDataUri2.default)(svg) + '") !important; }');
    }
    ...
    icons.forEach(function (icon) {
      ...
      var iconEl = _this.el.querySelector('.icon-' + icon.cls);
      var pageTitle = _this.el.getAttribute('data-page-title');
    ...
    var calendarLabelEl = this.el.querySelector('label.add-to-calendar-checkbox');
  ...
  HOIAddToCalendar.prototype.createCalendarComponent = function createCalendarComponent() {
    var buttonTarget = this.el;
    var calendar = (0, _addToCalendarButtons.createCalendar)({
      data: this.calendarData
    });
    buttonTarget.appendChild(calendar);
  };

  HOIAddToCalendar.prototype.createIcon = function createIcon(el) {
    ...
    if (lottie) {
      loaderAnimation = lottie.loadAnimation({
        ...
        renderer: 'svg',
        loop: false,
        animationData: _addToCalendar2.default // the path to the animation json
      });
  ...
  return HOIAddToCalendar;
}();

exports.default = HOIAddToCalendar;

},{"../../templates/partials/svg/apple.svg":66,"../../templates/partials/svg/google.svg":67,"../../templates/partials/svg/outlook.svg":68,"../animation/add-to-calendar.json":38,"add-to-calendar-buttons":1,"mini-svg-data-uri":32}],50:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = hoiShare;
...
function hoiShare() {
  ...
  var component = document.querySelector('.hoiShare');
  ...
  var twitterEl = component.querySelector('#twitter');
  if (twitterEl) {
    twitterEl.href = twitterURL();
  }
  var facebookEl = component.querySelector('#facebook');
  if (facebookEl) {
    facebookEl.href = facebookURL();
  }
  var shareEl = component.querySelector('#share');
  shareEl.addEventListener('click', function (e) {
    e.preventDefault();
    // console.log('copy')
  });

  var shareCopy = new _clipboard2.default(component.querySelector('#share'), {
    text: function text() {
  ...
  shareCopy.on('success', function (e) {
    var copyFeedback = component.querySelector('.hoiShare__Feedback');
...
},{"clipboard":3}],51:[function(require,module,exports){
'use strict';
...
var _getParam = require('../../../../../js/components/getParam');

var _getParam2 = _interopRequireDefault(_getParam);

var _KXEnv = require('../../../../../js/util/KXEnv');
...
var _HoiBambuser = require('../../../../home-of-innovation/HoiBambuser');

var _HoiBambuser2 = _interopRequireDefault(_HoiBambuser);

var _kxCountdown = require('../../../../../js/components/common/kxCountdown');

var _kxCountdown2 = _interopRequireDefault(_kxCountdown);

var _hoiShare = require('../../../../home-of-innovation/hoiShare');

var _hoiShare2 = _interopRequireDefault(_hoiShare);

var _hoiAddToCalendar = require('../../../../home-of-innovation/hoiAddToCalendar');

var _hoiAddToCalendar2 = _interopRequireDefault(_hoiAddToCalendar);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // Live Stream v4
...
var template = require('../../../../../templates/partials/home-of-innovation/hoiBambuser.hbs');
var templateTarget = document.querySelector('#bambuser-target');
// const titleTarget = document.querySelector('#title-target h1')

var countdownTarget = document.querySelector('#countdown-target');

var hoiAddToCalendarTemplate = require('../../../../../templates/partials/home-of-innovation/hoiAddToCalendar.hbs');
var calendarTarget = document.querySelector('#hoi-add-to-calendar-target');

var debugTemplate = require('../../../../../templates/partials/components/samsung-live/debug.hbs');

var MONTHS = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

// KV IMAGES
var DESKTOP_POSTER = 'https://images.samsung.com/is/image/samsung/assets/uk/explore/kings-cross/samsung-people-live/bespoke/Neo_KV_D.jpg';
var MOBILE_POSTER = 'https://images.samsung.com/is/image/samsung/assets/uk/explore/kings-cross/samsung-people-live/bespoke/Neo_kv_M.jpg';
...
var SamsungLive = function () {
  function SamsungLive() {
    var _this = this;

    _classCallCheck(this, SamsungLive);
    ...
    if (_KXEnv2.default.live) {
      SCHEDULE = SCHEDULE.filter(function (event) {
        return !event.test;
      });
    }

    this.pageInitiateTime = _luxon.DateTime.local();
    ...
    this.updateInterval = setInterval(function () {
      _this.update();
      if (_this.countdown) {
        _this.countdown.update(_this.getCurrentTime());
      }
    }, 1000);

    var debugMode = (0, _getParam2.default)('debug') || false;
    if (debugMode) {
      this.renderDebugMenu();
    }

    (0, _hoiShare2.default)();
  }

  SamsungLive.prototype.renderDebugMenu = function renderDebugMenu() {

    function linkString(date) {
      return window.location.pathname + '?debug=true&date=' + date.toFormat('yyyy-L-d-HH-m');
    }
    var shows = SCHEDULE.map(function (show) {
      var showDate = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(show.liveDate));
      var showEndDate = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(show.endDate));
    ...
    document.body.insertAdjacentHTML('beforeend', debugTemplate({
      ...
      trueTime: _luxon.DateTime.local().toFormat('ccc d LLL yyyy - HH:mm'),
      pageTime: this.getCurrentTime().toFormat('ccc d LLL yyyy - HH:mm'),
      shows: shows
    }));
  };

  SamsungLive.prototype.renderUnsupportedHeader = function renderUnsupportedHeader() {
  ...
  SamsungLive.prototype.renderHeader = function renderHeader(currentShow, nextShow) {

    var showData = _extends({}, currentShow);
    ...
    // init class
    new _HoiBambuser2.default(document.querySelector('.hoiBambuser'));
  };

  SamsungLive.prototype.update = function update() {
    // get shows based on current time
    var _getShows = this.getShows(),
        currentShow = _getShows.currentShow,
        nextShow = _getShows.nextShow;
    ...
    if (JSON.stringify(this.currentShow) !== JSON.stringify(currentShow)) {
  ...
  SamsungLive.prototype.renderAddToCalendar = function renderAddToCalendar(nextShow, currentShow) {
    var showData = nextShow || currentShow;
    if (!showData || showData.ended || showData.live) {
      return;
    }
    // construct reminder date from live date
    var month = MONTHS[showData.liveDate[1] - 1];
    var day = showData.liveDate[2];
    var year = showData.liveDate[0];
    var hour = showData.liveDate[3];
    var minute = ("00" + showData.liveDate[4]).substr(-2, 2);
    var madeDate = month + ' ' + day + ', ' + year + ' ' + hour + ':' + minute;
    ...
    new _hoiAddToCalendar2.default(calendarTarget.querySelector('.hoiAddToCalendar'));
  };

  SamsungLive.prototype.renderCountdown = function renderCountdown(nextShow) {
    this.countdown = new _kxCountdown2.default(countdownTarget, nextShow.liveDate, this.getCurrentTime());
  };

  SamsungLive.prototype.getCurrentTime = function getCurrentTime() {
    var now = _luxon.DateTime.local();
    // if date param exists (format ?date=YYYY-MM-DD-HH-SS ?date=2021-05-12-17-45)
    var manualDate = (0, _getParam2.default)('date') || false;
    if (manualDate) {
      manualDate = manualDate.split('-');
      manualDate = manualDate.map(function (x) {
        return parseInt(x, 10);
      });
      manualDate = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(manualDate));
      // calculate difference between page start and now
      var delta = now - this.pageInitiateTime;
  ...
  SamsungLive.prototype.generateShowStates = function generateShowStates(showData) {
    var now = this.getCurrentTime();
    var start = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(showData.liveDate)).setZone("GMT");
    var end = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(showData.endDate)).setZone("GMT");
    var afterLive = now > start;
    var beforeEnd = now < end;
    var afterEnd = now > end;
    var soon = _luxon.Interval.fromDateTimes(now, start).length('minutes') < 30;
    // const showStatus = {
    //   live: afterLive && beforeEnd,
    //   ended: afterEnd,
    //   soon: soon
    // }
    showData.live = afterLive && beforeEnd, showData.ended = afterEnd;
    showData.soon = soon;
    return showData;
  };

  SamsungLive.prototype.getShows = function getShows() {
    var currentTime = this.getCurrentTime();
    var nextShow = SCHEDULE.find(function (item) {
      var itemTime = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(item.liveDate)).setZone("GMT");
      if (_luxon.Interval.fromDateTimes(currentTime, itemTime).length('minutes') < 30) {
        return false;
      }
      return itemTime > currentTime;
    }) || false;
    // current show is one previous to next or the last in schedule
    var currentShow = nextShow ? SCHEDULE[SCHEDULE.indexOf(nextShow) - 1] : SCHEDULE[SCHEDULE.length - 1];

    // if there is a next show
    if (nextShow) {
      var nextShowTime = _luxon.DateTime.local.apply(_luxon.DateTime, _toConsumableArray(nextShow.liveDate)).setZone("GMT");
      // if the next show starts within 30 mins, use as current
      if (_luxon.Interval.fromDateTimes(currentTime, nextShowTime).length('minutes') < 30) {
        currentShow = nextShow;
      }
    }
    ...
    return { currentShow: currentShow, nextShow: nextShow };
  };
...
},{"../../../../../js/components/common/kxCountdown":42,"../../../../../js/components/getParam":46,"../../../../../js/util/KXEnv":54,"../../../../../templates/helpers/handlebarsHelpers":55,"../../../../../templates/partials/components/samsung-live/debug.hbs":60,"../../../../../templates/partials/home-of-innovation/hoiAddToCalendar.hbs":61,"../../../../../templates/partials/home-of-innovation/hoiBambuser.hbs":62,"../../../../bootstrap.js":40,"../../../../home-of-innovation/HoiBambuser":48,"../../../../home-of-innovation/hoiAddToCalendar":49,"../../../../home-of-innovation/hoiShare":50,"hbsfy/runtime":28,"luxon":31}],52:[function(require,module,exports){
"use strict";
...
},{"../dev/doLog":47}],53:[function(require,module,exports){
"use strict";
...
},{"./KXEnv":54}],54:[function(require,module,exports){
'use strict';
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"kxCountdownDigit__figure\" in>"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"in") || (depth0 != null ? lookupProperty(depth0,"in") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"in","hash":{},"data":data,"loc":{"start":{"line":3,"column":45},"end":{"line":3,"column":51}}}) : helper)))
    + "</div>\n";
  ...
  return "    <div class=\"kxCountdownDigit__figure\" out>"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"out") || (depth0 != null ? lookupProperty(depth0,"out") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"out","hash":{},"data":data,"loc":{"start":{"line":6,"column":46},"end":{"line":6,"column":53}}}) : helper)))
    + "</div>\n";
  ...
  return "<div class=\"kxCountdownDigit\">\n"
    + ((stack1 = (lookupProperty(helpers,"if_defined")||(depth0 && lookupProperty(depth0,"if_defined"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"in") : depth0),{"name":"if_defined","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":2},"end":{"line":4,"column":17}}})) != null ? stack1 : "")
    + ((stack1 = (lookupProperty(helpers,"if_defined")||(depth0 && lookupProperty(depth0,"if_defined"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"out") : depth0),{"name":"if_defined","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":2},"end":{"line":7,"column":17}}})) != null ? stack1 : "")
    + "</div>\n";
},"useData":true});

},{"hbsfy/runtime":28}],57:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"kxCountdown\">\n  <h3>We will be live again in:</h3>\n  <div class=\"kxCountdown__groups\">\n    <div class=\"kxCountdown__group\" label=\"Days\">\n      <div class=\"kxCountdown__digit\" day_0></div>\n      <div class=\"kxCountdown__digit\" day_1></div>\n    </div>\n    <div class=\"kxCountdown__group kxCountdown__group--spacer\"></div>\n    <!-- <div class=\"kxCountdown__digit\"><span>:</span></div> -->\n    <div class=\"kxCountdown__group\" label=\"Hours\">\n      <div class=\"kxCountdown__digit\" hour_0></div>\n      <div class=\"kxCountdown__digit\" hour_1></div>\n    </div>\n    <div class=\"kxCountdown__group kxCountdown__group--spacer\"></div>\n    <!-- <div class=\"kxCountdown__digit\"><span>:</span></div> -->\n    <div class=\"kxCountdown__group\" label=\"Minutes\">\n      <div class=\"kxCountdown__digit\" minute_0></div>\n      <div class=\"kxCountdown__digit\" minute_1></div>\n    </div>\n    <div class=\"kxCountdown__group kxCountdown__group--spacer\"></div>\n    <!-- <div class=\"kxCountdown__digit\"><span>:</span></div> -->\n    <div class=\"kxCountdown__group\"label=\"Seconds\">\n      <div class=\"kxCountdown__digit\" second_0></div>\n      <div class=\"kxCountdown__digit\" second_1></div>\n    </div>\n  </div>\n</div>\n";
},"useData":true});

},{"hbsfy/runtime":28}],58:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":28}],59:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;
...
},{"hbsfy/runtime":28}],60:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <div class=\"SamsungLiveDebug__show\">\n        <strong>#"
    + alias3((lookupProperty(helpers,"index-plus")||(depth0 && lookupProperty(depth0,"index-plus"))||alias2).call(alias1,(data && lookupProperty(data,"index")),{"name":"index-plus","hash":{},"data":data,"loc":{"start":{"line":14,"column":17},"end":{"line":14,"column":38}}}))
    + "</strong><br>\n        <strong>"
    + alias3(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":15,"column":16},"end":{"line":15,"column":25}}}) : helper)))
    + "</strong><br>\n        <strong>Bambuser ID: "
    + alias3(((helper = (helper = lookupProperty(helpers,"showID") || (depth0 != null ? lookupProperty(depth0,"showID") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"showID","hash":{},"data":data,"loc":{"start":{"line":16,"column":29},"end":{"line":16,"column":39}}}) : helper)))
    + "</strong><br>\n        <strong>Start Date:</strong> "
    + alias3(((helper = (helper = lookupProperty(helpers,"readableStart") || (depth0 != null ? lookupProperty(depth0,"readableStart") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"readableStart","hash":{},"data":data,"loc":{"start":{"line":17,"column":37},"end":{"line":17,"column":54}}}) : helper)))
    + "<br>\n        <strong>End Date:</strong> "
    + alias3(((helper = (helper = lookupProperty(helpers,"readableEnd") || (depth0 != null ? lookupProperty(depth0,"readableEnd") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"readableEnd","hash":{},"data":data,"loc":{"start":{"line":18,"column":35},"end":{"line":18,"column":50}}}) : helper)))
    + "<br>\n        <hr>\n        <div class=\"SamsungLiveDebug__show_links\">\n          <a href=\""
    + alias3(alias5(((stack1 = (depth0 != null ? lookupProperty(depth0,"links") : depth0)) != null ? lookupProperty(stack1,"liveminus30") : stack1), depth0))
    + "\">Live (-30min)</a>\n          <a href=\""
    + alias3(alias5(((stack1 = (depth0 != null ? lookupProperty(depth0,"links") : depth0)) != null ? lookupProperty(stack1,"liveminus5") : stack1), depth0))
    + "\">Live (-5min)</a>\n          <a href=\""
    + alias3(alias5(((stack1 = (depth0 != null ? lookupProperty(depth0,"links") : depth0)) != null ? lookupProperty(stack1,"live") : stack1), depth0))
    + "\">Live</a>\n          <a href=\""
    + alias3(alias5(((stack1 = (depth0 != null ? lookupProperty(depth0,"links") : depth0)) != null ? lookupProperty(stack1,"endminus5") : stack1), depth0))
    + "\">End (-5min)</a>\n          <a href=\""
    + alias3(alias5(((stack1 = (depth0 != null ? lookupProperty(depth0,"links") : depth0)) != null ? lookupProperty(stack1,"end") : stack1), depth0))
    + "\">End</a>\n        </div>\n      </div>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3="function", alias4=container.escapeExpression, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return "<div class=\"SamsungLiveDebug\" draggable=\"true\">\n  <h2>Samsung Live Debug</h2>\n  <hr>\n  <a class=\"purp-button\" href=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"reset") || (depth0 != null ? lookupProperty(depth0,"reset") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"reset","hash":{},"data":data,"loc":{"start":{"line":4,"column":31},"end":{"line":4,"column":40}}}) : helper)))
    + "\">Reset Time</a><br>\n  <label class=\"purp-button\" for=\"hide-check\">Toggle Schedule Visibility</label><input id=\"hide-check\" type=\"checkbox\" name=\"hide-check\"/>\n  <div class=\"SamsungLiveDebug__body\">\n    <hr>\n    <strong>True Time:</strong> "
    + alias4(((helper = (helper = lookupProperty(helpers,"trueTime") || (depth0 != null ? lookupProperty(depth0,"trueTime") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"trueTime","hash":{},"data":data,"loc":{"start":{"line":8,"column":32},"end":{"line":8,"column":44}}}) : helper)))
    + "<br>\n    <strong>Page Time:</strong> "
    + alias4(((helper = (helper = lookupProperty(helpers,"pageTime") || (depth0 != null ? lookupProperty(depth0,"pageTime") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"pageTime","hash":{},"data":data,"loc":{"start":{"line":9,"column":32},"end":{"line":9,"column":44}}}) : helper)))
    + "\n    <hr>\n    <h2>Schedule</h2>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"shows") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":12,"column":4},"end":{"line":28,"column":13}}})) != null ? stack1 : "")
    + "  </div>\n</div>\n\n<style>\n.SamsungLiveDebug {\n  padding: 0.5rem;\n  position: fixed;\n  top: 1rem;\n  right: 1rem;\n  width: 300px;\n  z-index: 200000;\n  background: #f4f4f4;\n  font-size: 0.8em;\n  border: 2px solid black;\n}\n.SamsungLiveDebug__body {\n  overflow: scroll;\n  max-height: 400px;\n  margin-top: 0.5em\n}\n.SamsungLiveDebug hr {\n  display: block;\n}\n.SamsungLiveDebug h2 {\n  font-size: 1em;\n}\n.SamsungLiveDebug__show {\n  padding: 0.5em;\n  border: 1px solid #666;\n  background: rgba(0,0,0,0.05);\n  margin-bottom: 1em;\n}\n.SamsungLiveDebug__show_links {\n  display: flex;\n  flex-direction: column;\n  padding: 0.25em;\n}\n.SamsungLiveDebug__show_links a, .SamsungLiveDebug .purp-button {\n  display: block;\n  margin-bottom: 0.25em;\n  padding: 0.25em;\n  background: #5034a2;\n  border-radius: 3px;\n  border-style: outset;\n  border-width: 2px;\n  color: white;\n  text-align: center;\n}\n.SamsungLiveDebug .purp-button {\n  margin-bottom: 0;\n  display: inline-block;\n}\n.SamsungLiveDebug__show_links a:hover {\n  background: #6743d2;\n}\n#hide-check:checked + .SamsungLiveDebug__body {\n  display: none;\n}\n</style>\n";
},"useData":true});

},{"hbsfy/runtime":28}],61:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"hoiAddToCalendar\"\n  data-page-title=\""
    + alias1(container.lambda(((stack1 = (data && lookupProperty(data,"root"))) && lookupProperty(stack1,"title")), depth0))
    + "\"\n  data-title=\""
    + alias1(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":3,"column":14},"end":{"line":3,"column":23}}}) : helper)))
    + "\"\n  data-description=\""
    + alias1(((helper = (helper = lookupProperty(helpers,"description") || (depth0 != null ? lookupProperty(depth0,"description") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"description","hash":{},"data":data,"loc":{"start":{"line":4,"column":20},"end":{"line":4,"column":35}}}) : helper)))
    + "\"\n  data-start=\""
    + alias1(((helper = (helper = lookupProperty(helpers,"start") || (depth0 != null ? lookupProperty(depth0,"start") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"start","hash":{},"data":data,"loc":{"start":{"line":5,"column":14},"end":{"line":5,"column":23}}}) : helper)))
    + "\"\n  data-address=\""
    + alias1(((helper = (helper = lookupProperty(helpers,"address") || (depth0 != null ? lookupProperty(depth0,"address") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"address","hash":{},"data":data,"loc":{"start":{"line":6,"column":16},"end":{"line":6,"column":27}}}) : helper)))
    + "\"\n  data-duration=\""
    + alias1(((helper = (helper = lookupProperty(helpers,"duration") || (depth0 != null ? lookupProperty(depth0,"duration") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"duration","hash":{},"data":data,"loc":{"start":{"line":7,"column":17},"end":{"line":7,"column":29}}}) : helper)))
    + "\"\n  data-end=\""
    + alias1(((helper = (helper = lookupProperty(helpers,"end") || (depth0 != null ? lookupProperty(depth0,"end") : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"end","hash":{},"data":data,"loc":{"start":{"line":8,"column":12},"end":{"line":8,"column":19}}}) : helper)))
    + "\">\n</div>\n";
},"useData":true});

},{"hbsfy/runtime":28}],62:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
    return "";
  ...
  stack1 = ((helper = (helper = lookupProperty(helpers,"lastShow") || (depth0 != null ? lookupProperty(depth0,"lastShow") : depth0)) != null ? helper : container.hooks.helperMissing),(options={"name":"lastShow","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(4, data, 0),"data":data,"loc":{"start":{"line":20,"column":6},"end":{"line":23,"column":6}}}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),options) : helper));
  if (!lookupProperty(helpers,"lastShow")) { stack1 = container.hooks.blockHelperMissing.call(depth0,stack1,options)}
  if (stack1 != null) { return stack1; }
  else { return ''; }
},"4":function(container,depth0,helpers,partials,data) {
    return "        <h4>Next Stream:</h4>\n      ";
  ...
  return "      <p class=\"hoiBambuser__Description\">"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"description") || (depth0 != null ? lookupProperty(depth0,"description") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"description","hash":{},"data":data,"loc":{"start":{"line":27,"column":42},"end":{"line":27,"column":57}}}) : helper)))
    + "</p>\n";
  ...
  return "      <a\n        class=\"btn btn--primary btn--primary--coral  hoiBambuser__Launch "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"live") : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":33,"column":73},"end":{"line":33,"column":117}}})) != null ? stack1 : "")
    + "\"\n        data-omni-type=\"microsite\"\n        data-omni=\"uk:kings-cross:samsung-people-live:launch show\"\n        ga-ca=\"microsite\"\n        ga-ac=\"feature\"\n        ga-la=\"uk:kings-cross:samsung-people-live:launch show\"\n        >\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"cta") : depth0),{"name":"if","hash":{},"fn":container.program(11, data, 0),"inverse":container.program(13, data, 0),"data":data,"loc":{"start":{"line":40,"column":8},"end":{"line":48,"column":15}}})) != null ? stack1 : "")
    + "        <div class=\"hoiBambuser__LaunchIcon\">\n"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"play_icon"),depth0,{"name":"play_icon","data":data,"indent":"          ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "        </div>\n      </a>\n";
},"9":function(container,depth0,helpers,partials,data) {
    return "hoiBambuser__Launch--live";
},"11":function(container,depth0,helpers,partials,data) {
  ...
  return "          "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"cta") || (depth0 != null ? lookupProperty(depth0,"cta") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"cta","hash":{},"data":data,"loc":{"start":{"line":41,"column":10},"end":{"line":41,"column":19}}}) : helper))) != null ? stack1 : "")
    + "\n";
},"13":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"live") : depth0),{"name":"if","hash":{},"fn":container.program(14, data, 0),"inverse":container.program(16, data, 0),"data":data,"loc":{"start":{"line":42,"column":8},"end":{"line":48,"column":8}}})) != null ? stack1 : "");
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"ended") : depth0),{"name":"if","hash":{},"fn":container.program(17, data, 0),"inverse":container.program(19, data, 0),"data":data,"loc":{"start":{"line":44,"column":8},"end":{"line":48,"column":8}}})) != null ? stack1 : "");
},"17":function(container,depth0,helpers,partials,data) {
    return "          Replay Live Demo\n";
},"19":function(container,depth0,helpers,partials,data) {
    return "          Starting Soon\n        ";
},"21":function(container,depth0,helpers,partials,data) {
    return "  <svg height=\"100%\" viewBox=\"0 0 24 24\"><path fill=\"white\" d=\"M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-3 17v-10l9 5.146-9 4.854z\"/></svg>\n";
},"23":function(container,depth0,helpers,partials,data) {
    return "\n<svg class=\"hoiBambuser__LiveIcon\" version=\"1.1\" id=\"Layer_1\" x=\"0px\" y=\"0px\" viewBox=\"0 0 183 80\" style=\"enable-background:new 0 0 183 80;\">\n<style type=\"text/css\">\n  .st0{fill:#FF4337;}\n  .st1{fill:#FFFFFF;}\n</style>\n<path class=\"st0\" d=\"M171,80H12C5.4,80,0,74.6,0,68V12C0,5.4,5.4,0,12,0h159c6.6,0,12,5.4,12,12v56C183,74.6,177.6,80,171,80z\"/>\n<g>\n  <circle class=\"st1\" cx=\"38\" cy=\"40.1\" r=\"16.5\"/>\n  <g>\n    <path class=\"st1\" d=\"M94.8,51.5v4.9H76v-33h5.4v28.1H94.8z\"/>\n    <path class=\"st1\" d=\"M99.8,23.5h5.4v33h-5.4V23.5z\"/>\n    <path class=\"st1\" d=\"M136.2,23.5l-10.1,33h-5.9l-10.1-33h5.7l7.5,27.2l7.4-27.2H136.2z\"/>\n    <path class=\"st1\" d=\"M161.5,51.6v4.9H141v-33h19.9v4.9h-14.5v8.8h10.7V42h-10.7v9.5H161.5z\"/>\n  </g>\n</g>\n</svg>\n\n\n";
  ...
  return "<div\n  class=\"hoiBambuser\"\n  showID=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"showID") || (depth0 != null ? lookupProperty(depth0,"showID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"showID","hash":{},"data":data,"loc":{"start":{"line":3,"column":10},"end":{"line":3,"column":20}}}) : helper)))
    + "\"\n  style=\"background-image:url("
    + alias4(((helper = (helper = lookupProperty(helpers,"poster") || (depth0 != null ? lookupProperty(depth0,"poster") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"poster","hash":{},"data":data,"loc":{"start":{"line":4,"column":30},"end":{"line":4,"column":40}}}) : helper)))
    + ")\"\n>\n  <style>\n    @media screen and (max-width: 768px) {\n      .hoiBambuser {\n          background-image:url("
    + alias4(((helper = (helper = lookupProperty(helpers,"mobile_poster") || (depth0 != null ? lookupProperty(depth0,"mobile_poster") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"mobile_poster","hash":{},"data":data,"loc":{"start":{"line":9,"column":31},"end":{"line":9,"column":48}}}) : helper)))
    + ") !important;\n      }\n    }\n  </style>\n  <div class=\"hoiBambuser__Body\">\n    <div>\n      <h1>Samsung <br>People</h1>\n"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"live_icon"),depth0,{"name":"live_icon","data":data,"indent":"      ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "    </div>\n    <div class=\"hoiBambuser__NextSteam\">\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"live") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.program(3, data, 0, blockParams, depths),"data":data,"loc":{"start":{"line":19,"column":6},"end":{"line":23,"column":13}}})) != null ? stack1 : "")
    + "      <h2>"
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":24,"column":10},"end":{"line":24,"column":19}}}) : helper)))
    + "</h2>\n    </div>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"description") : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":26,"column":4},"end":{"line":28,"column":11}}})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"unsupported") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.program(8, data, 0, blockParams, depths),"data":data,"loc":{"start":{"line":30,"column":4},"end":{"line":53,"column":11}}})) != null ? stack1 : "")
    + "  </div>\n</div>\n\n\n\n\n";
  ...
  fn = lookupProperty(decorators,"inline")(fn,props,container,{"name":"inline","hash":{},"fn":container.program(21, data, 0, blockParams, depths),"inverse":container.noop,"args":["play_icon"],"data":data,"loc":{"start":{"line":58,"column":0},"end":{"line":60,"column":11}}}) || fn;
  fn = lookupProperty(decorators,"inline")(fn,props,container,{"name":"inline","hash":{},"fn":container.program(23, data, 0, blockParams, depths),"inverse":container.noop,"args":["live_icon"],"data":data,"loc":{"start":{"line":63,"column":0},"end":{"line":83,"column":11}}}) || fn;
  return fn;
  }

,"useDecorators":true,"usePartial":true,"useData":true,"useDepths":true});

},{"hbsfy/runtime":28}],63:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
    var helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
...
},{"hbsfy/runtime":28}],64:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
...
},{"hbsfy/runtime":28}],65:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
