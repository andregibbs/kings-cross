...
},{"./components/common/KXNav":37,"./components/common/kxSurvey":39,"./components/findKX":40,"./util/GATracking.js":50,"es6-promise/auto":2,"jquery":27,"lity":28,"whatwg-fetch":31}],36:[function(require,module,exports){
'use strict';
...
},{"../dev/doLog":44,"../polyfill/customevent-polyfill":48,"./getUrlVars":42,"./handleTemplate":43}],37:[function(require,module,exports){
'use strict';
...
},{"../../animation/nav-burger-animation.json":34,"./kxSearch":38}],38:[function(require,module,exports){
'use strict';
...
},{"../../../data/config.json":32,"../../../templates/helpers/handlebarsHelpers":52,"../../../templates/partials/components/common/kxEventTile.hbs":53,"../../../templates/partials/home-of-innovation/hoiLinkList.hbs":55,"../../../templates/partials/home-of-innovation/partials/listItem.hbs":56,"../../../templates/partials/home-of-innovation/partials/listItemSpacer.hbs":57,"../../util/Events":49,"../../util/KXEnv":51,"fuse.js":4,"hbsfy/runtime":26}],39:[function(require,module,exports){
'use strict';
...
},{"../../../../src/data/kxSurveyData":33,"../../../templates/partials/components/common/kxSurvey.hbs":54,"../../util/KXEnv":51,"../getParam":41}],40:[function(require,module,exports){
'use strict';
...
},{"../util/KXEnv":51}],41:[function(require,module,exports){
'use strict';
...
},{"../../templates/helpers/handlebarsHelpers":52}],44:[function(require,module,exports){
'use strict';
...
var HOILinkListHoverScroll = function () {
  function HOILinkListHoverScroll(el) {
    var _this = this;

    _classCallCheck(this, HOILinkListHoverScroll);
    ...
    this.leftScroll.addEventListener('mouseenter', function () {
      _this.animating = true;
      _this.directionForward = false;
      _this.startScrolling();
    });

    this.leftScroll.addEventListener('mouseleave', function () {
      _this.animating = false;
    });

    this.rightScroll.addEventListener('mouseenter', function () {
      _this.animating = true;
      _this.directionForward = true;
      _this.startScrolling();
    });

    this.rightScroll.addEventListener('mouseleave', function () {
      _this.animating = false;
    });

    this.scrollEl.addEventListener('scroll', function () {
      requestAnimationFrame(_this.checkEndOfScroll.bind(_this));
    });
  }

  HOILinkListHoverScroll.prototype.startScrolling = function startScrolling() {
    var direction = this.directionForward ? this.scrollSpeed : this.scrollSpeed * -1;
    if (this.animating) {
  ...
  HOILinkListHoverScroll.prototype.shouldShowScrollArrows = function shouldShowScrollArrows() {
    var scrollChildren = this.scrollEl.querySelectorAll('.hoiList__Item');
  ...
  HOILinkListHoverScroll.prototype.checkEndOfScroll = function checkEndOfScroll() {
    var el = this.scrollEl;
    var leftEnd = el.scrollLeft <= 0;
    var rightEnd = el.scrollWidth - (el.scrollLeft + el.offsetWidth) <= 0;
    if (leftEnd) {
  ...
  return HOILinkListHoverScroll;
}();

var HOILinkListHoverManager = function HOILinkListHoverManager() {
  _classCallCheck(this, HOILinkListHoverManager);

  this.instances = [].slice.call(document.querySelectorAll('.hoiLinkList--scroll')).map(function (element) {

    return new HOILinkListHoverScroll(element);
  });
};

exports.default = HOILinkListHoverManager;
...
var doLog = (0, _doLog2.default)(); // import customevent from '../polyfill/customevent-polyfill';
function support() {
    ...
    var oneToOneVars = {
        ...
        header: function header(inputLength) {
            var remaining = Math.max(oneToOneVars.maxLength - inputLength, 0);
    ...
    var state = {
        ...
        startJourney: function startJourney(cat) {
        ...
        cancelJourney: function cancelJourney() {
    ...
    // returning state for use outside of /support
    return state;
}

},{"../../dev/doLog":44}],47:[function(require,module,exports){
'use strict';
...
var _HOILinkListHoverScroll = require('../../home-of-innovation/HOILinkListHoverScroll');

var _HOILinkListHoverScroll2 = _interopRequireDefault(_HOILinkListHoverScroll);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function KXtras() {
  new _HOILinkListHoverScroll2.default(); // init link list manager for hoiLists

  // fetchData(function (allEvents) {
  (0, _calendar2.default)("https://bookings.qudini.com/booking-widget/booker/slots/IZ0LYUJL6B0/4375/68391/0", "appointment");
  // });

  var supportBooking = (0, _booking2.default)();

  document.querySelector('#booking-launch').addEventListener('click', function () {
...
},{"../../bootstrap.js":35,"../../components/calendar":36,"../../home-of-innovation/HOILinkListHoverScroll":45,"./booking":46,"slick-carousel":30}],48:[function(require,module,exports){
"use strict";
...
},{"../dev/doLog":44}],50:[function(require,module,exports){
"use strict";
...
},{"./KXEnv":51}],51:[function(require,module,exports){
'use strict';
